  ...
  - path: /etc/frr/frr.conf
    content: |
      ...
      router bgp {2}
        ...
        !
        ! Hub2 (westus3) - VPN GW Instance 1
        ...
        !
        ! Hub3 (eastus2) - VPN GW Instance 1
